 ...
 #
 # NOTE: If you're having issues, try making sure that $AGENT.jar is included 
 # in the project build/path in eclipse, try making sure that the project name 
 # in the agent file is correct, try making sure that the configuration file is... 
